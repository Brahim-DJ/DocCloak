...
export const fr: Translations = {
  ...
  spreadsheet: {
    anonymizeTab: 'Anonymiser',
    restoreTab: 'Restaurer',
    uploadHeading: 'Importer un classeur',
    uploadSubtitle: '.xlsx \u2014 colonnes et lignes préservées',
    uploadButton: 'Importer un classeur',
    anonymizeSelected: 'Anonymiser la sélection',
    downloadRedacted: 'Télécharger la version anonymisée',
    entriesRedacted: (n) => `${n} entrée${n !== 1 ? 's' : ''} anonymisée${n !== 1 ? 's' : ''}`,
    clear: 'Effacer',
    selectColumns: 'Sélectionner les colonnes à anonymiser',
    redactedValues: 'Valeurs anonymisées',
    selectAll: 'Tout sélectionner',
    deselectAll: 'Effacer',
    showingRows: (shown, total) => `${shown} / ${total} lignes affichées`,
    rowColCount: (rows, cols) => `${rows} lignes, ${cols} colonnes`,
    colLabel: (n) => `Colonne ${n + 1}`,
    pasteSubTab: 'Coller le texte',
    uploadSubTab: 'Importer un fichier',
    pasteDescription: 'Collez le texte anonymisé provenant de l\'IA pour restaurer les valeurs originales',
    pastePlaceholder: 'Collez le texte anonymisé ici...',
    restoreButton: 'Restaurer',
    restoreLabel: 'Texte restauré',
    uploadDescription: 'Importez un classeur anonymisé pour restaurer les valeurs originales',
    downloadRestored: 'Télécharger la version restaurée',
    restoring: 'Restauration\u2026',
    uploadRedacted: 'Importer un fichier .xlsx anonymisé',
    unsupportedFormat: 'Format non pris en charge',
    failedToRead: 'Échec de la lecture du classeur',
    failedToRestore: 'Échec de la restauration du classeur',
    downloaded: 'Téléchargé',
