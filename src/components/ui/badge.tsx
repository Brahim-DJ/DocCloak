...
const badgeVariants = cva(
  "inline-flex items-center border px-2.5 py-0.5 font-sans text-[10px] uppercase tracking-[0.12em] font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-[#223159] text-[#FAFAFA]",
        secondary:
          "border-transparent bg-[#E8E8E5] text-[#0E131B]",
        destructive:
          "border-transparent bg-[#DC2626] text-[#FAFAFA]",
        outline: "text-[#223159] border-[#223159]",
      },
    },
    defaultVariants: {
      variant: "default",
