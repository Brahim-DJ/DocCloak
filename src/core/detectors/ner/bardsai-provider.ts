 ...
 *
 * XLM-RoBERTa-base fine-tuned for EU PII detection (24 languages).
 * 36 entity types, 277M parameters, quantized ONNX (~279 MB).
...
/** id2label — 36 entity types from bardsai/eu-pii-anonimization-multilang config.json */
